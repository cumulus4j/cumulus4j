...
final class RESTRequestFactory {
	...
	/**
	 * <p>
	 * The jquery_container defined in sample.html contains two callback
	...
	private static native void createJSFunctions(final RESTRequestFactory util) /*-{
		$wnd.jquery_container.doRESTCallback = function(data, textStatus,
			...
			util.@org.cumulus4j.integrationtest.gwt.client.RESTRequestFactory::restCallback(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(data, textStatus, xmlHttpRequest, id);
		}
		...
		$wnd.jquery_container.doRESTErrorCallback = function(xmlHttpRequest,
			...
			util.@org.cumulus4j.integrationtest.gwt.client.RESTRequestFactory::restErrorCallback(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(xmlHttpRequest, textStatus, errorThrown, id);
		}
	}-*/;
	...
	public void restCallback(final JavaScriptObject data,
			...
			final String id) {
		GWT.log("RESTRequestFactory:restCallback");
	...
	public void restErrorCallback(final JavaScriptObject xmlHttpRequest,
		...
		GWT.log("RESTRequestFactory:restErrorCallback");
	...
	private static native void doCallREST(final String url, final String data,
			final String method, final String id, final String username,
			final String password)/*-{
		$wnd.jquery_container.callREST(url, data, method, id, username,
				password);
	}-*/;
	...
	public static void callREST(final RESTRequest request,
		...
		doCallREST(request.getUrl(), request.getData().toString(),
				DEFAULT_HTTP_METHOD, id, request.getUsername(),
				request.getPassword());
	}
}
