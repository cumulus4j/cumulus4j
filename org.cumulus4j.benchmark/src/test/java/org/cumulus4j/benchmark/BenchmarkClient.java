...
public class BenchmarkClient {
	...
	.getLogger(BenchmarkClient.class);
	...
	+ "/org.cumulus4j.benchmark.server";
...
//	private static final char[] KEY_SERVER_PASSWORD = "testtesttest".toCharArray();
	...
	private String invokeOnServer(Client client, String cryptoSessionID, String service, String methodName) throws Exception{
		...
		String url = URL_INTEGRATIONTEST_WEBAPP + "/" + service + "/" + methodName + "?cryptoSessionID="
	...
	public void startInvocation(TestCase testCase) throws Exception {
