...
extends AbstractTransactionalTest
{
	...
	public void createTestData()
	{
...

		{
			...
			owner.addElementA(new ElementA("Element K1.1"), elementA_V1_1);
			owner.addElementA(new ElementA("Element K1.2"), new ElementA("Element V1.2"));
			owner.addElementA(elementA_K1_3, new ElementA("Element V1.3"));
			owner.addElementA(new ElementA("Element K1.4"), new ElementA("Element V1.4"));
...

		{
			...
			owner.addElementA(new ElementA("Element K2.1"), new ElementA("Element V2.1"));
			owner.addElementA(new ElementA("Element K2.2"), new ElementA("Element V2.2"));
			owner.addElementA(elementA_K1_3, new ElementA("Element V2.3"));
			owner.addElementA(new ElementA("Element K2.4"), new ElementA("Element V2.4"));
		}

		{
			ElementAMapOwner3 owner = pm.makePersistent(new ElementAMapOwner3());
			owner.setName("Owner 3");
			owner.addElementA(new ElementA("Element K3.1"), elementA_V1_1);
			owner.addElementA(new ElementA("Element K3.2"), new ElementA("Element V3.2"));
			owner.addElementA(new ElementA("Element K3.3"), new ElementA("Element V3.3"));
		}

		{
			ElementAMapOwner3 owner = pm.makePersistent(new ElementAMapOwner3());
			owner.setName("Owner 4");
			owner.addElementA(elementA_K1_3, new ElementA("Element V4.3"));
		}
...

		{
			...
			owner.addElementA(new ElementA("Element K6.2"), new ElementA("Element V6.2"));
		}
	}
